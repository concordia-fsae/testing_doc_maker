...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scroll_fields_contents.setGeometry(QtCore.QRect(0, 0, 665, 506))
        ...
        self.gridLayout_3.addWidget(self.fr_general_info, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_import, 1, 0, 1, 1)
        ...
        self.layout_document_settings.setItem(1, QtWidgets.QFormLayout.FieldRole, spacerItem3)
        ...
        self.list_roster = QtWidgets.QListView(self.tab_roster)
        self.list_roster.setObjectName("list_roster")
        self.gridLayout_2.addWidget(self.list_roster, 0, 0, 1, 1)
